    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('customerReportResult')}}" method="POST" role="search" autocomplete="off">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id}}" {{isset($section_id)==$section->id?'selected':''}}> {{ $section->section_name }}</option>
                                @endforeach
                            </select>
                        </div>
