<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">نظام اداره الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoice')}}">قائمه الفواتير</a></li>
							<li><a class="slide-item" href="">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="">الفواتير الغير مدفوعه</a></li>
							<li><a class="slide-item" href="">الفواتير المدفوعه جزئيا</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('section')}}">الاقسام</a></li>
