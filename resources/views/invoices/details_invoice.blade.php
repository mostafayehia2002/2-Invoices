...
{{--    --}}
    @if (session()->has('add-attachment'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>{{ session()->get('add-attachment') }}</strong>
        </div>
    @endif



    @if (session()->has('delete-attachment'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session()->get('delete-attachment') }}</strong>
        </div>
    @endif
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            ...
                                            <div class="card card-statistics">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form method="POST" action="{{route('invoiceDetails.store')}}" enctype="multipart/form-data">
                                                           @csrf
